...
def navigate_to_next_page(driver: webdriver.Chrome) -> None:
    try:
        next_button = driver.find_element(
            By.CLASS_NAME, "ecomerce-items-scroll-more"
        )
...
def scrape_products_from_page() -> Dict[str, List]:
...
def get_all_products() -> None:
    products_data = scrape_products_from_page()
